...
bosh interpolate \
  ...
  --ops-file ../bosh-release-compiler/tasks/create-bosh-director/manifest-ops.yml \
...
source ../bosh-release-compiler/bin/target-bosh-director

bosh -n update-cloud-config \
  --ops-file ../bosh-release-compiler/tasks/create-bosh-director/cloud-config-ops.yml \
  --vars-store vars.yml \
